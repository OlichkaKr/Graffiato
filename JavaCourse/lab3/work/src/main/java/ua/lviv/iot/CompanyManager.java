...
public class CompanyManager {
    ...
    public final List<Plane> getPlaneList() {
        return planeList;
    }
    ...
    public final void setTotalCapacity(final int pTotalCapacity) {
        this.totalCapacity = pTotalCapacity;
    }

    public final double getTotalLoadCapacity() {
        return totalLoadCapacity;
    }

    public final void setTotalLoadCapacity(final double pTotalLoadCapacity) {
        this.totalLoadCapacity = pTotalLoadCapacity;
    }
}
