...
public class View {
    ...
    public void manager(String num){
        switch (num){
            ...
            case "6": {
                System.out.println("Capacity of all planes is " + companyManager.totalCapacity(planeList) + " tones.");
                break;
            }
            case "7": {
                System.out.println("Load capacity of all planes is " + companyManager.totalLoadCapacity(planeList) + " tones.");
                break;
            }
            default: {
